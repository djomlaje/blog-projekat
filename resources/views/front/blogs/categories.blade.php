...
@section('seo_title', __('Category Page'))
@section('seo_description', __('Blogs in your best category ') . $category->name)
...
<div class="container">
    <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
            <div class="container">
                <h2 class="mb-3"><?php echo htmlspecialchars("Category " . '"' . $category->name . '"'); ?></h2>
                <div class="row">
                    ...
                    <div class="post col-xl-6">
                        ...
                        <div class="post-details">
                            ...
                            <footer class="post-footer d-flex align-items-center"><a href="{{$blog->getAuthorUrl()}}" class="author d-flex align-items-center flex-wrap">
