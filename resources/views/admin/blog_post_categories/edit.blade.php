...
@section('seo_title', __('Edit Blog Post Category'))
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Edit Post Category')</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.blog_post_categories.update', ['blogPostCategory' => $blogPostCategory->id])}}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea 
                                    ...
                                    name="description"
                                >{{old('description', $blogPostCategory->description)}}</textarea>
